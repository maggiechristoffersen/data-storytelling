...
<div>
  <Scroller layout="right">
    {#snippet sticky()}
      <div>
        <p>
          You can use the event triggered by an Intersection Observer any way
          you want!
        </p>
        ...
        <p>
          ...
          <strong>
            change something other than the element that triggered the event.
          </strong>
        </p>
        <p>
          To see this section in action again, you'll have to refresh the page.
        </p>
      </div>
    {/snippet}
    ...
    {#snippet scrolly()}
      ...
      <ObservedArticleText callback={alertCallback} {options}>
        This <code>{"<ArticleText>"}</code> component causes an alert to show
        ...
        <br /><br />
        <strong
          >You can use an Intersection Observer event to trigger changes:</strong
        >
        <ul>
      ...
      <ObservedArticleText callback={simpleCallback} {options}>
        Think of the Intersection Observer event trigger like any other event:
        <ul>
          <li>a <code>mouseover</code> event</li>
          <li>a <code>mouseclick</code> event</li>
          <li>a keyboard key being pressed</li>
        </ul>
        Any of these kinds of events can be used to trigger any action you want to
        take on the page.
      </ObservedArticleText>

      <ObservedArticleText callback={simpleCallback} {options}>
        <strong>
          🤔 How might you use this functionality to draw attention to something
          on your website?
        </strong>
      </ObservedArticleText>
    {/snippet}
